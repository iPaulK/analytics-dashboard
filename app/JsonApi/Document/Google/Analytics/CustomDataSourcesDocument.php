...
/**
 * Class CustomDataSourcesDocument
 * @package App\JsonApi\Document\Google\Analytics
 */
class CustomDataSourcesDocument extends AbstractCollectionDocument
{
    public function __construct(CustomDataSourceTransformer $transformer)
    {
