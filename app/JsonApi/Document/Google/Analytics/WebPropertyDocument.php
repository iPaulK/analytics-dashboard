...
/**
 * Class WebPropertyDocument
 * @package App\JsonApi\Document\Google\Analytics
 */
class WebPropertyDocument extends AbstractSingleResourceDocument
{
    public function __construct(WebPropertyTransformer $transformer)
    {
