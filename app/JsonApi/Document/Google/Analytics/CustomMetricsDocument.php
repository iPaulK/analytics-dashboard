...
/**
 * Class CustomMetricsDocument
 * @package App\JsonApi\Document\Google\Analytics
 */
class CustomMetricsDocument extends AbstractCollectionDocument
{
    public function __construct(CustomMetricTransformer $transformer)
    {
