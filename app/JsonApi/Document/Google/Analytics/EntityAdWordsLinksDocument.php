...
/**
 * Class EntityAdWordsLinksDocument
 * @package App\JsonApi\Document\Google\Analytics
 */
class EntityAdWordsLinksDocument extends AbstractCollectionDocument
{
    public function __construct(EntityAdWordsLinkTransformer $transformer)
    {
