<?php
namespace App\JsonApi\Document\Google\SearchConsole;
...
/**
 * Class SiteDocument
 * @package App\JsonApi\Document\Google\SearchConsole
 */
class SiteDocument extends AbstractSingleResourceDocument
{
