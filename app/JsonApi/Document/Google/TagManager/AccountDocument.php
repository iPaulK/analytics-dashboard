<?php
namespace App\JsonApi\Document\Google\TagManager;
 ...
 * @package App\JsonApi\Document\Google\TagManager
 */
class AccountDocument extends AbstractSingleResourceDocument
{
