...
/**
 * Class CustomDataSourceTransformer
 * @package App\JsonApi\Transformer
 */
class CustomDataSourceTransformer extends AbstractResourceTransformer
{
    /**
    ...
    public function getAttributes($data): array
    {
        return [
            ...
            "customDataSourceId" => function ($data) {
                return $data["customDataSourceId"];
            },
            ...
            "uploadType" => function ($data) {
                return $data["uploadType"];
            },
            "importBehavior" => function ($data) {
                return $data["importBehavior"];
            },
            "profilesLinked" => function ($data) {
                return json_decode($data["profilesLinked"]);
            },
