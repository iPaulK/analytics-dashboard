<?php
namespace App\JsonApi\Transformer\Google\TagManager;
...
class AccountTransformer extends AbstractResourceTransformer
{
    ...
    public function getAttributes($account): array
    {
        return [
            ...
            "fingerprint" => function ($account) {
                return $account["fingerprint"];
            },
            "path" => function ($account) {
                return $account["path"];
            },
            "shareData" => function ($account) {
                return json_decode($account["shareData"]);
            },
            "tagManagerUrl" => function ($account) {
                return $account["tagManagerUrl"];
            },
